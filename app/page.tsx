...
export default function Home() {
  ...
  return (
    <div className="grid grid-rows-[auto_1fr_20px] items-center justify-items-center min-h-screen px-8 sm:px-20 pb-20 gap-16 font-[family-name:var(--font-geist-sans)]">
      <header className="row-start-1 w-full flex justify-end mt-6">
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <h1 className="text-8xl font-bold">
          Current Block Number: {isLoading ? "Loading..." : count}
        </h1>
        <button
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
        ...
        <a
          className="flex items-center gap-[24px] flex-wrap items-center justify-center"
